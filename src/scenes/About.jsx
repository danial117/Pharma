        ...
        <div className="w-full xs:max-sm:mb-16">
            <div className="h-[500px] xs:max-sm:grid-cols-1 xs:max-sm:h-auto grid grid-cols-2 w-full ">
               <div className="py-[4rem] xs:max-sm:pt-12 xs:max-sm:pb-2 w-[70%] mx-auto">
                <p  className="font-Lexend xs:max-sm:text-[1rem] sm:max-md:text-[1.3rem] text-[1.7rem]">We offer a better health to everyone</p>
                <p className="font-Abel xs:max-sm:text-[10px] sm:max-md:text-[14px] my-4 text-[1rem]"> We are a group of comapanies involved to help you in your medication plans. We offer a better solution for your healthcare medications. We offer great plans to help you manage your medications regularly.A better medical solution to everyone to help live a better life. We want to help you in your medical diagnostics.we love our customers</p>
                </div>
        ...
        <div className="w-full xs:max-sm:my-16 my-4 ">
            ...
            <div style={{backgroundImage: `linear-gradient(to right,rgba(0,0,0,0.7), rgba(0,0,0,0.8)), url(${require('../assets/2.jpeg')})`}}  className="w-full bg-cover bg-center xs:max-sm:h-[400px] h-[500px] my-auto">
             ...
             <div className="w-[60%] sm:max-md:w-[80%] xs:max-sm:w-[90%]   mx-auto py-24">
                <p className="text-center xs:max-sm:text-[3rem] sm:max-md:text-[5rem] text-[4rem] font-Abel text-white">Our Mission</p>
                <p className="text-white xs:max-sm:text-xs font-Livvic">Our mission is to improve patient outcomes by providing innovative, reliable, and cost-effective medical supplies. We believe that every patient deserves the best care possible, and we are committed to supporting healthcare professionals in achieving that goal. We aim to enhance patient care and outcomes through our commitment to quality, innovation, and exceptional service. Our equipment is sourced from leading manufacturers and is designed to support healthcare professionals in delivering efficient and effective care.
                </p>
...
<img src={require('../assets/3.jpeg')} className="w-full h-[400px]"  />
               ...
               <div className="py-[4rem] xs:max-sm:py-8 xs:max-sm:w-[80%]  w-[70%] mx-auto">
                <p  className="font-Lexend sm:max-md:text-[1.3rem] text-[1.7rem]">Our Commitment</p>
                <p className="font-Abel sm:max-md:text-[14px] my-4 xs:max-sm:text-[10px] text-[1rem]">We are dedicated to making a meaningful impact on the healthcare industry by continuously striving to improve our products and services. Our commitment to excellence is reflected in everything we do, from the products we supply to the relationships we build with our customers.</p>
                </div>
